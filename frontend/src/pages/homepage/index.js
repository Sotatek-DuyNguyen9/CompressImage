  ...
  return (
    <div className="homepage">
      ...
      <p className="homepage__description">
        Công cụ nén ảnh này sử dụng một hệ thống thông minh từ sự tối ưu hóa tốt
        nhất và thuật toán lượng tử hóa vector để nén hình ảnh JPEG, GIF và PNG
        thành dung lượng nhỏ nhất có thể với cấp độ chất lượng yêu cầu.
      </p>
